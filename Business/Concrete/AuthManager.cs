...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        private IUserService _userDal;
        private ITokenHelper _tokenHelper;
        public AuthManager(IUserService userDal, ITokenHelper tokenHelper)
        {
            _userDal = userDal;
        ...
        {
            var userToCheck = _userDal.GetByMail(userForLoginDto.Email);
            if (userToCheck == null)
            {
        ...
        {
            if (_userDal.GetByMail(email) != null)
            {
